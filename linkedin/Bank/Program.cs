...
Console.WriteLine(IsSuccessful &= (checking.Balance == 2500.0m));
IsSuccessful &= (checking.AccountOwner == "John Doe");
Console.WriteLine(IsSuccessful &= (checking.AccountOwner == "John Doe"));
...
Console.WriteLine(IsSuccessful &= (saving.Balance == 1000.0m));
IsSuccessful &= (saving.AccountOwner == "Jane Doe");
Console.WriteLine(IsSuccessful &= (saving.AccountOwner == "Jane Doe"));

// Deposit some money in each account.
checking.Deposit(200.0m);
saving.Deposit(150.0m);
IsSuccessful &= (checking.Balance == 2700.0m);
Console.WriteLine(IsSuccessful &= (checking.Balance == 2700.0m));
IsSuccessful &= (saving.Balance == 1150.0m);
Console.WriteLine(IsSuccessful &= (saving.Balance == 1150.0m));
...
Console.WriteLine(IsSuccessful &= (checking.Balance == 2650.0m));
IsSuccessful &= (saving.Balance == 1025.0m);
Console.WriteLine(IsSuccessful &= (saving.Balance == 1025.0m));

// Apply the Savings interest.
saving.ApplyInterest();
IsSuccessful &= (saving.Balance == 1055.75m);
Console.WriteLine(IsSuccessful &= (saving.Balance == 1055.75m));
...
Console.WriteLine((saving.Balance == 993.75m));
...
Console.WriteLine( (checking.Balance == -385.00m));