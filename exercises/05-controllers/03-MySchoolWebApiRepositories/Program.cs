...
builder.Services.AddSingleton<ICoursesRepository, InMemoryCoursesRepository>();
builder.Services.AddSingleton<ICourseInstancesService, CourseInstancesService>();
builder.Services.AddSingleton<ICourseInstancesRepository, InMemoryCourseInstancesRepository>();
